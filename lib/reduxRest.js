...
var Endpoint = exports.Endpoint = function () {
  function Endpoint(url) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref$withCSRF = _ref.withCSRF,
        withCSRF = _ref$withCSRF === undefined ? false : _ref$withCSRF,
        _ref$CSRFHeaderName = _ref.CSRFHeaderName,
        CSRFHeaderName = _ref$CSRFHeaderName === undefined ? 'X-CSRFToken' : _ref$CSRFHeaderName,
        _ref$CSRFCookieName = _ref.CSRFCookieName,
        CSRFCookieName = _ref$CSRFCookieName === undefined ? 'csrftoken' : _ref$CSRFCookieName,
  ...
  _createClass(Endpoint, [{
    key: '_addDynamicHeader',
    value: function _addDynamicHeader(request, headers) {
      if (headers) {
    ...
    key: 'list',
    value: function list(params, headers) {
      return this._addDynamicHeader(this._prepareRequest(_superagent2.default.get(this.url)).query(params), headers);
    }
  }, {
    key: 'retrieve',
    value: function retrieve(id, headers) {
      return this._addDynamicHeader(this._prepareRequest(_superagent2.default.get(this._getObjectURL(id))), headers);
    }
  }, {
    key: 'create',
    value: function create(conf, headers) {
      return this._addDynamicHeader(this._prepareRequest(_superagent2.default.post(this.url)).send(conf), headers);
    }
  }, {
    key: 'update',
    value: function update(conf, id) {
      ...
      return this._prepareRequest(_superagent2.default[method](this._getObjectURL(id))).send(conf);
    }
  }, {
    key: '_prepareRequest',
...
var ActionCreators = exports.ActionCreators = function () {
  ...
  _createClass(ActionCreators, [{
    key: '_createAction',
    value: function _createAction(action, apiRequest, payload, objectID, method) {
      var _this3 = this;

      return function (dispatch) {
        var pendingID = _this3._getPendingID();
        var call = apiRequest(payload, objectID, method).end(function (err, res) {
          if (err) {
...
var ItemReducer = exports.ItemReducer = function (_BaseReducer) {
  ...
  function ItemReducer() {
    ...
    return _possibleConstructorReturn(this, (ItemReducer.__proto__ || Object.getPrototypeOf(ItemReducer)).apply(this, arguments));
  }
...
var CollectionReducer = exports.CollectionReducer = function (_BaseReducer2) {
  ...
  function CollectionReducer() {
    ...
    return _possibleConstructorReturn(this, (CollectionReducer.__proto__ || Object.getPrototypeOf(CollectionReducer)).apply(this, arguments));
  }
